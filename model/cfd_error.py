...
class SuperResNet(torch.nn.Module):
    def __init__(self, in_channels, width, out_channels, num_layers=4):
        ...
        self.kernel = KernelConv(width, width, kernel=PowerSeriesKernel, num_layers=2, num_powers=4)
        # self.operator_kernel = DenseNet([1, width, width, ], nn.ReLU())
...
class KernelConv(pyg_nn.MessagePassing):
    def __init__(self, in_channel, out_channel, kernel, num_layers=3, **kwargs):
        ...
        self.kernel = kernel(in_channel=1, out_channel=out_channel, num_layers=num_layers, **kwargs)
        self.operator_kernel = DenseNet([64, 128, 128, out_channel**2], nn.ReLU)
    ...
    def message(self, x_j, pseudo):
        ...
        weight = self.operator_kernel(weight).view(-1, 64, 64)
...
class PowerSeriesKernel(nn.Module):
    def __init__(self, num_layers, num_powers, activation=nn.ReLU, **kwargs):
        ...
        self.conv_out = PowerSeriesConv(64, 64, num_powers)
        self.activation = activation()
